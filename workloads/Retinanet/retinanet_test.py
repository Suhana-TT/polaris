...
def run_standalone(outdir: str = '.') -> None:
    ...
    for name, cfg in retinanet_cfgs.items():
        ...
        # TODO(Polaris-ONNX): Enable ONNX export once RetinaNet exposes a
        # get_forward_graph() (or equivalent) API. At that point, obtain the
        # forward graph from the model and call graph2onnx to dump:
