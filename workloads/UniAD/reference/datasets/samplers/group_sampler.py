    ...
    def __iter__(self):
        ...
        for i, size in enumerate(self.group_sizes):
            if size > 0:
                ...
                # use torch.randperm with the seeded generator to ensure deterministic shuffling
                perm = torch.randperm(int(size), generator=g).tolist()
                indice = indice[perm].tolist()
                extra = int(
