...
from ...common.enums import StateSE2Index
from diffusers.schedulers import DDIMScheduler
from .modules.conditional_unet1d import ConditionalUnet1D, SinusoidalPosEmb
import torch.nn.functional as F
from .modules.blocks import linear_relu_ln, bias_init_with_prob, gen_sineembed_for_position, GridSampleCrossBEVAttention
...
class BoundingBox2DIndex(IntEnum):
    ...
    @classmethod
    @property
    def X(cls): return cls._X

    @classmethod
    @property
    def Y(cls): return cls._Y
    ...
    @classmethod
    @property
    def LENGTH(cls): return cls._LENGTH
    ...
    @classmethod
    @property
    def POINT(cls): return slice(cls._X, cls._Y + 1)

    @classmethod
    @property
    def STATE_SE2(cls): return slice(cls._X, cls._HEADING + 1)
class V2TransfuserModel(nn.Module):
    ...
    def __init__(self, config: TransfuserConfig):
        ...
        self._keyval_embedding = nn.Embedding(config.lidar_vert_anchors * config.lidar_horz_anchors + 1, config.tf_d_model)  # 8x8 feature grid + trajectory
