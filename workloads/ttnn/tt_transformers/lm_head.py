...
class LMHead():
    def __init__(
        ...
        max_columns_per_device = size_per_device  # num_splits = 1
        ...
        elif args.is_simulation():
            self.program_configs = [None]
        else:
            self.program_configs = [
    ...
    def forward(self, x: ttnn.Tensor):
        ...
        for weight, pc in zip(self.output_weights, self.program_configs):
            output = ttnn.linear(
                ...
                program_config=pc,
                memory_config=None, #ttnn.L1_WIDTH_SHARDED_MEMORY_CONFIG,
