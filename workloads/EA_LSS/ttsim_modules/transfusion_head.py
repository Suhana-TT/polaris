...
from workloads.EA_LSS.ttsim_modules.multihead_attention import MultiheadAttention
from workloads.EA_LSS.ttsim_modules.position_embedding_learned import PositionEmbeddingLearned
from workloads.EA_LSS.ttsim_modules.ffn import FFN
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if initialize_by_heatmap:
            ...
            from workloads.EA_LSS.ttsim_modules.mlp import ConvModule1d
